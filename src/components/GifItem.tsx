...
export const GifItem: React.FC<IProps> = ({ id, title, url }) => {
    ...
    return (
        <div className="max-w-sm w-full lg:max-w-full lg:flex mb-2">
            <div className="h-48 lg:h-auto lg:w-48 flex-none rounded-l text-center overflow-hidden" style={{ backgroundImage: `url(${url})`, backgroundSize: `cover`, backgroundRepeat: `no-repeat` }} title={title}></div>
